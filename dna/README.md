...
* [Article Link](https://cs50.harvard.edu/x/2023/psets/6/dna/)
* [Video](https://youtu.be/j84b_EgntcQ)
...
What might such a DNA database look like? Well, in its simplest form, you could imagine formatting a [DNA database](https://www.fbi.gov/services/laboratory/biometric-analysis/codis/codis-and-ndis-fact-sheet) as a CSV file, wherein each row corresponds to an individual, and each column corresponds to a particular STR.
~~~bash
name,AGAT,AATG,TATC
Alice,28,42,14
Bob,17,22,19
